...
describe TruncateTags do
  ...
  describe "<r:truncate>" do
    it "should truncate the contents with ActionView::Base.truncate_html" do
      @page.should render(
        %{<r:truncate><p>This is a story about a very <strong>strong</strong> man</p><p>It is <em>very</em> boring.</p></r:truncate>}
    ...
    it "should accept an 'omission' attribute" do
      ...
      @page.should render(
        %{<r:truncate omission=",,,">#{test}</r:truncate>}
      ).as(expected)
    end
    it "should accept a 'length' attribute" do
      ...
      @page.should render(
        %{<r:truncate length="10">#{test}</r:truncate>}
      ).as(expected)
    end
    describe "with strip_html set to 'true'" do
      it "should strip html tags" do
        @page.should render("<r:truncate strip_html='true'><div class='red'>Something</div> <ul><li>Lalala</li></ul></r:truncate>").as("Something Lalala")
      end
      it "should strip extra whitespace" do
        @page.should render("<r:truncate strip_html='true'><div class='red'>                       Something</div>\n\n      <ul><li>Lalala</li></ul></r:truncate>").as("Something Lalala")
      end
      it "should not strip extra whitespace with strip_whitespace set to 'false'" do
        @page.should render(
          "<r:truncate strip_html='true' strip_whitespace='false'><div class='red'>          Something</div>\n\n                      
             <ul><li>Lalala</li></ul></r:truncate>"
        ).as("          Something\n\n                      \n   ...")
      end
      it "should not split words" do
        @page.should render("<r:truncate strip_html='true' length='14'>Something to split</r:truncate>").as('Something...')
      end
      it "should split words with split_words set to 'true'" do
        @page.should render("<r:truncate strip_html='true' length='14' split_words='true'>Something to split</r:truncate>").as('Something t...')
      end
    end
  end
end